...
> 本页用于快速理解项目边界、数据流和组件职责。详细约束、决策记录与迁移顺序仍以根目录的 [架构方案](../../架构方案.md) 为准。
...
[![前端组件图与令牌映射](../../design/component-map/frontend-component-map.png)](../../前端组件图与设计令牌映射.md)
...
- [用户流程](../../用户流程.md)
- [手机端低保真线框图](../../手机端页面线框图.md)
- [移动端视觉规范](../../移动端视觉规范.md)
- [前端组件图与设计令牌映射](../../前端组件图与设计令牌映射.md)
- [异常恢复用户流程](../../异常恢复用户流程.md)
- [异常恢复低保真线框图](../../异常恢复页面线框图.md)
