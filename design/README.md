...
本目录只保存可以直接查看或继续编辑的设计产物；产品说明和设计决策文档统一放在 [`docs/design/`](../docs/design/)。
...
- HTML 与对应 PNG 使用相同文件名，便于查找。
- 临时截图不放入本目录；只有用于评审或回归的基线图才提交。
- 设计说明、决策理由和组件职责写入 [`docs/design/`](../docs/design/)。
